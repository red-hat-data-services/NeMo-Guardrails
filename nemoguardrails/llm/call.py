...
try:
    from nemoguardrails.header_forwarding import get_extra_headers_for_llm as _get_extra_headers_for_llm
except ImportError:

    def _get_extra_headers_for_llm(_llm: Any) -> Optional[dict]:
        return None
...
async def llm_call(
    ...
    extra_headers = _get_extra_headers_for_llm(llm)
    if extra_headers:
